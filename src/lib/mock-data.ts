...
export const notifications = [
  { title: "New qualified lead", body: "Emeka Nwosu asked for bulk pricing on WhatsApp.", time: "2m ago" },
  { title: "Appointment booked", body: "Tuesday 2:00 PM fitting with Sarah Okonkwo.", time: "18m ago" },
  { title: "Human takeover requested", body: "Daniel Ajayi's TikTok thread needs an agent.", time: "1h ago" },
  { title: "Usage at 74%", body: "1,840 of 2,500 DMs used this billing cycle.", time: "5h ago" },
];
