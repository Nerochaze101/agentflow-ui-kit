...
export const Route = createFileRoute("/pricing")({
  head: () => ({
    meta: [
      { title: "Pricing — AutoAgent AI Plans in Naira & Dollars" },
      {
        name: "description",
        content:
          "Transparent AutoAgent AI pricing: Starter, Growth and Agency tiers in NGN, plus Starter, Pro and Enterprise in USD.",
      },
      { property: "og:title", content: "Pricing — AutoAgent AI Plans in Naira & Dollars" },
      {
        property: "og:description",
        content: "Compare AutoAgent AI plans in NGN and USD, from 2 channels to unlimited DMs and CRM sync.",
      },
    ],
  }),
  component: Pricing,
